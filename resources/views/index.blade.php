...
@section('header')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Menu Utama Informasi Keuangan Sekolah</h3>
            <h6 class="op-7 mb-2">YAYASAN AL-IRSYAD GARUT</h6>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <h4 class="text-info fw-bold">Rp.4.500.000</h4>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <h4 class="text-success fw-bold">Rp. 75.525.000</h4>
                    </div>
                    <div class="progress progress-sm">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h6><b>Saldon Piutang</b></h6>
                            <p class="text-muted">Hari ini</p>
                        </div>
                        <h4 class="text-danger fw-bold">15.250.000</h4>
                    </div>
                    <div class="progress progress-sm">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h6><b>Siswa</b></h6>
                            <p class="text-muted">Bayar hari ini</p>
                        </div>
                        <h4 class="text-secondary fw-bold">12 Siswa</h4>
                    </div>
                    <div class="progress progress-sm">
