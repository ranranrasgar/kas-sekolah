                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-auto mb-2 mb-md-0">
                            <h4 class="card-title m-0">
                                ...
                                @endif --}}
                                {{-- @if ($categoryId && $journals->isNotEmpty() && $journals->first()->journalCategory)
                                    Data - {{ $journals->first()->journalCategory->name }}
                                @endif --}}
                            </h4>
                        </div>
                        <!-- Filter & Tombol -->
                        <div class="col-12 col-md d-flex flex-wrap flex-md-nowrap justify-content-md-end gap-2">
                            ...
                            <form method="GET" action="{{ route('journals.index') }}" class="d-flex flex-wrap gap-2">
                                ...
                                <div class="d-flex align-items-end gap-2">
                                    ...
                                    <a href="{{ route('journals.index') }}" class="btn btn-sm btn-secondary">Reset</a>
                                </div>
                            </form>
                                ...
                                @foreach ($journals as $journal)
                                    @foreach ($journal->journalEntries as $entry)
                                        <tr>
                                            ...
                                            <td>{{ $entry->coa->code ?? 'N/A' }}</td>
                                            <td>{{ $entry->coa->name ?? 'N/A' }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <form id="deleteForm-{{ $journal->id }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="button"
                                                            class="btn btn-link btn-danger btn-sm delete-btn"
